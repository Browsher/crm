...
test('0027 preserva empresas, contatos, carteira, reserva e recentes na Base de testes, sem autovínculo futuro', async () => {
  ...
  try {
    ...
    expect(await aplicar(banco.urlAdmin, PASTA_MIGRACOES)).toEqual({ok:true,aplicadas:['0027_grupos_importacao.sql', '0028_comercial.sql', '0029_funil_comandos.sql', '0030_funil_avanco.sql', '0031_vendas_carteira_agenda.sql']})
