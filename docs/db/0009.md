...
> **Alterado depois:** a [0022](0022.md) exige versão na emissão, muda a leitura da credencial e incrementa a versão na troca.

> **Alterado depois:** a 0012 fez `senha_trocar` gravar
> `autenticacao.credencial.atualizado_por` com o próprio usuário. Ver
> `docs/db/0012.md`.
