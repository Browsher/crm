...
export default async function PaginaConfiguracao() {
  ...
  return <main className={styles.pagina}>
    <header><Link href="/whatsapp">Voltar ao WhatsApp</Link><h1>Configurar vendedores</h1><p>Associe vendedores às instâncias existentes da Evolution para consultar suas conversas.</p></header>
    ...
    <section className={styles.cartao} aria-labelledby="titulo-vinculos">
      ...
      <p>Remover um vínculo não exclui a instância nem o histórico da Evolution.</p>
